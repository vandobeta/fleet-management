...
class SmsManager(private val context: Context) {
    ...
    private val trackerPhoneNumber: String
        get() {
            val prefs = context.getSharedPreferences("tracker_prefs", Context.MODE_PRIVATE)
            return prefs.getString("tracker_number", "") ?: ""
        }
    ...
    fun sendCommand(command: String, callback: (Boolean, String) -> Unit) {
        val phoneNumber = trackerPhoneNumber
    ...
    fun processIncomingSms(from: String?, body: String?): SmsResponse? {
        ...
        return when {
            ...
            body?.contains("successfully") == true -> {
